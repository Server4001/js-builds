...
var GistBox = React.createClass({ displayName: "GistBox",
    ...
    addGist: function addGist(userInput) {
        ...
        $.get(url, (function (data) {
            ...
            // Calling .bind() make the "this" variable inside the $.get callback the same as outside the callback (the react object). Otherwise, "this" would refer to the ajax callback function.
    ...
    render: function render() {
        ...
        return React.createElement("div", null, React.createElement("h1", null, "GistBox"), React.createElement(GistAddForm, { onAdd: this.addGist }), this.state.gists.map(newGist));
    }
});

React.render(React.createElement(GistBox, null), document.querySelector('#app'));
//# sourceMappingURL=gist_box.js.map
