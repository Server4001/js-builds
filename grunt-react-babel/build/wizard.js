...
var Wizard = (function (_React$Component) {
    ...
    _createClass(Wizard, [{
        ...
        value: function updateAspectRatio(width, height) {
        ...
        value: function render() {
            return React.createElement("div", null, React.createElement(PrintSize, { changeAspectRatio: this.updateAspectRatio.bind(this) }), React.createElement("input", { type: "text", value: this.state.aspectRatio, readOnly: true }), React.createElement(Cropper, { aspectRatio: this.state.aspectRatio }));
        }
    }]);
