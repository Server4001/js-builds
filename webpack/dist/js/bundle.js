...
/***/ function(module, exports, __webpack_require__) {
	...
	let doSomething = (() => {
	    var _ref = _asyncToGenerator(function* (event) {
	        ...
	        let json = yield UrlHelper.hitEndpoint('/');
	
	        $('#txtOutput').val(json);
	    });
	
	    return function doSomething(_x) {
	...
	const NumbersController = __webpack_require__(2);
	const UrlHelper = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const NumbersHelper = __webpack_require__(3);
	const jQuery = __webpack_require__(4);
